  ...
  methods: {
    ...
    processYoutube() {
      if (this.meiFile.name !== '' && this.youtubeUrl !== '') {
        ...
        // collect user data in form data object
        ...
        axios
          ...
          .then((response) => {
            ...
            reader.onload = () => {
              ...
              // add click event listener to score
              d3.select('.system')
                .append('rect')
                .attr('id', 'click-area')
                .attr('x', 0)
              ...
              d3.select('#click-area')
                .on('click', () => {
                  // jump in video to clicked position in score
              ...
              // build lookup tables for pixel position <-> time position
              ...
              // periodically update cursor position
              setInterval(() => {
        ...
        axios
          ...
          .then((response) => {
            ...
            reader.onload = () => {
              ...
              d3.select('#click-area')
                .on('click', () => {
                  // jump in audio to clicked position in score
    ...
    getPixelFromTime(time) {
      ...
      // interpolate between values for smooth cursor animation
